...
def run_whisper_cli():
    ...
    if limit_mode == "2":
        max_chars = int(get_user_input("줄당 최대 글자 수", "42"))
    else:
        max_words = int(get_user_input("줄당 최대 단어 수", "8"))

    max_lines = int(get_user_input("자막당 최대 줄 수", "1"))
    ...
    print("분석 중...")
    result = mlx_whisper.transcribe(filepath, **transcribe_options)
